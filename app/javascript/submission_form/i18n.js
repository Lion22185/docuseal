...
const sl = {
  ...
  must_be_valid_zip: 'Mora biti veljavna poštna številka (XXXXX ali XXXXX-XXXX)',
  ...
  text: 'Besedilo',
  by_clicking_you_agree_to_the: 'S klikom na »{button}« se strinjate z',
  electronic_signature_disclosure: 'Razkritjem o elektronskem podpisu',
  esignature_disclosure: 'Razkritje o e-podpisu',
  signature: 'Podpis',
  initials: 'Inicialke',
  ...
  page: 'Stran',
  select_your_option: 'Izberite možnost',
  ...
  open_source_documents_software: 'odprtokodna programska oprema za dokumente',
  ...
  upload: 'Naloži',
  files: 'Datoteke',
  signature_is_too_small_or_simple_please_redraw: 'Podpis je premajhen ali prepreprost. Prosimo, narišite ga ponovno.',
  browser_privacy_settings_block_canvas: 'Nastavitve zasebnosti vašega brskalnika omejujejo uporabo platna za risanje. Uporabite drug brskalnik ali napravo ali onemogočite nastavitve zasebnosti, ki blokirajo platno, da lahko podpišete.',
