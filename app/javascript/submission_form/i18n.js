...
const sl = {
  step: 'Korak',
  form_progress: 'Napredek obrazca',
  close: 'Zapri',
  uploaded_files: 'Naložene datoteke',
  signature_drawing_area: 'Področje za risanje podpisa. Za risanje podpisa uporabite miško ali dotik.',
  initials_drawing_area: 'Področje za risanje inicialk. Za risanje inicialk uporabite miško ali dotik.',
  kba: 'KBA',
  please_upload_an_image_file: 'Prosimo naložite slikovno datoteko',
  must_be_characters_length: 'Mora biti dolgo natanko {number} znakov',
  must_be_valid_ssn: 'Mora biti veljaven SSN (XXX-XX-XXXX)',
  must_be_valid_ein: 'Mora biti veljaven EIN (XX-XXXXXXX)',
  must_be_valid_email: 'Mora biti veljaven e-poštni naslov',
  must_be_valid_url: 'Mora biti veljaven URL (začne se z http:// ali https://)',
  must_be_valid_zip: 'Mora biti veljavna ZIP poštna številka (XXXXX ali XXXXX-XXXX)',
  must_contain_numbers_only: 'Vsebovati mora samo številke',
  must_contain_letters_only: 'Vsebovati mora samo črke',
  complete_all_required_fields_to_proceed_with_identity_verification: 'Izpolnite vsa obvezna polja za nadaljevanje preverjanja identitete.',
  verify_id: 'Preveri osebni dokument',
  identity_verification: 'Preverjanje identitete',
  complete: 'Dokončaj',
  fill_all_required_fields_to_complete: 'Izpolnite vsa obvezna polja za dokončanje',
  sign_and_complete: 'Podpiši in dokončaj',
  text: 'Besedilo',
  by_clicking_you_agree_to_the: 'S klikom na "{button}" se strinjate s',
  electronic_signature_disclosure: 'Razkritjem o elektronskem podpisu',
  esignature_disclosure: 'Razkritje e-podpisa',
  signature: 'Podpis',
  initials: 'Inicialke',
  sign_on_the_touchscreen: 'Podpišite se na zaslonu na dotik',
  approved: 'Odobreno',
  reviewed: 'Pregledano',
  other: 'Drugo',
  authored_by_me: 'Avtor: jaz',
  invite: 'Povabi',
  email: 'E-pošta',
  approved_by: 'Odobril',
  reviewed_by: 'Pregledal',
  authored_by: 'Avtor',
  select_a_reason: 'Izberite razlog',
  scan_the_qr_code_with_the_camera_app_to_open_the_form_on_mobile_and_draw_your_signature: 'Skenirajte QR kodo s fotoaparatom, da odprete obrazec na mobilni napravi in narišete svoj podpis',
  date: 'Datum',
  number: 'Številka',
  value_is_invalid: 'Vrednost je neveljavna',
  verification_code_is_invalid: 'Potrditvena koda je neveljavna',
  already_paid: 'Že plačano',
  image: 'Slika',
  pay: 'Plačaj',
  take_photo: 'Fotografiraj',
  number_phone_is_invalid: 'Telefonska številka {number} je neveljavna',
  file: 'Datoteka',
  digitally_signed_by: 'Digitalno podpisal',
  reason: 'Razlog',
  select: 'Izberi',
  ...
  continue: 'Nadaljuj',
  sign_now: 'Podpiši zdaj',
  type_here_: 'Vnesite tukaj ...',
  optional: 'neobvezno',
  option: 'Možnost',
  appears_on: 'Prikaže se na',
  page: 'Stran',
  select_your_option: 'Izberite svojo možnost',
  complete_hightlighted_checkboxes_and_click: 'Izpolnite označena potrditvena polja in kliknite',
  submit: 'oddaj',
  next: 'naprej',
  click_to_upload: 'Kliknite za nalaganje',
  or_drag_and_drop_files: 'ali povlecite in spustite datoteke',
  send_copy_via_email: 'Pošlji kopijo prek e-pošte',
  download: 'Prenesi',
  clear: 'Počisti',
  redraw: 'Ponovno nariši',
  draw_initials: 'Nariši inicialke',
  type_signature_here: 'Vnesite podpis tukaj',
  type_initial_here: 'Vnesite inicialke tukaj',
  form_has_been_completed: 'Obrazec je bil dokončan!',
  document_has_been_signed: 'Dokument je bil podpisan!',
  documents_have_been_signed: 'Dokumenti so bili podpisani!',
  create_a_free_account: 'Ustvari brezplačen račun',
  powered_by: 'Poganja',
  please_check_the_box_to_continue: 'Prosimo označite polje za nadaljevanje.',
  open_source_documents_software: 'programska oprema za dokumente odprte kode',
  verified_phone_number: 'Preveri telefonsko številko',
  country_code: 'Koda države',
  use_international_format: 'Uporabite mednarodno obliko: +386 ...',
  six_digits_code: '6-mestna koda',
  change_phone_number: 'Spremeni telefonsko številko',
  sending: 'Pošiljanje ...',
  resend_code: 'Ponovno pošlji kodo',
  verification_code_has_been_resent: 'Potrditvena koda je bila ponovno poslana prek SMS',
  please_fill_all_required_fields: 'Prosimo izpolnite vsa obvezna polja',
  set_today: 'Nastavi današnji datum',
  toggle_multiline_text: 'Preklopi večvrstično besedilo',
  draw_signature: 'Nariši podpis',
  type_initial: 'Vnesi inicialke',
  draw: 'Nariši',
  type: 'Vnesi',
  type_text: 'Vnesi besedilo',
  ...
  upload: 'Naloži',
  files: 'Datoteke',
  signature_is_too_small_or_simple_please_redraw: 'Podpis je preveč majhen ali preprost. Prosimo ponovno narišite.',
  browser_privacy_settings_block_canvas: 'Nastavitve zasebnosti vašega brskalnika omejujejo uporabo platna za risanje. Uporabite drug brskalnik ali napravo ali onemogočite nastavitve zasebnosti, ki blokirajo canvas, da lahko podpišete.',
  wait_countdown_seconds: 'Počakajte {countdown} sekund',
  enter_screen_reader_mode: 'Vklopi način za bralnik zaslona'
}

const i18n = { en, es, it, de, fr, pl, uk, cs, pt, he, nl, ar, ko, ja, sl }
