...
const sl = {
  ...
  fixed: 'Fiksno',
  default: 'Privzeto',
  save_as_custom_field: 'Shrani kot polje po meri',
  kba: 'KBA',
  analyzing_: 'Analiziranje ...',
  download: 'Prenesi',
  downloading_: 'Prenašanje ...',
  view: 'Ogled',
  autodetect_fields: 'Samodejno zaznaj polja',
  payment_link: 'Povezava do plačila',
  strikeout: 'Prečrtano',
  draw_strikethrough_the_document: 'Prečrtaj čez dokument',
  quantity: 'Količina',
  prefillable: 'Predizpolnljivo',
  signature_id: 'ID podpisa',
  ...
  method: 'Metoda',
  reorder_fields: 'Prerazporedi polja',
  verify_id: 'Preveri osebni dokument',
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more: 'Pridobite kvalificiran elektronski podpis (QeS) pri zaupanja vrednem ponudniku. Kliknite za več informacij.',
  editable: 'Uredljivo',
  recurrent: 'Ponavljajoče',
  one_off: 'Enkratno',
  search_field: 'Išči polje',
  field_not_found: 'Polje ni najdeno',
  clear: 'Počisti',
  align: 'Poravnaj',
  resize: 'Spremeni velikost',
  width: 'Širina',
  height: 'Višina',
  add_all_required_fields_to_continue: 'Dodaj vsa obvezna polja za nadaljevanje',
  uploaded_pdf_contains_form_fields_keep_or_remove_them: 'Naloženi PDF vsebuje polja obrazca. Ohrani ali odstrani?',
  keep: 'Ohrani',
  left: 'Levo',
  heading: 'Naslov',
  validation: 'Preverjanje',
  add_blank_page: 'Dodaj prazno stran',
  edit_documents: 'Uredi dokumente',
  move_forward: 'Premakni naprej',
  move_backward: 'Premakni nazaj',
  remove_page: 'Odstrani stran',
  merge_with_previous: 'Združi s prejšnjo',
  merge_with_next: 'Združi z naslednjo',
  move_up: 'Premakni gor',
  move_down: 'Premakni dol',
  rotate: 'Zavrti',
  redact: 'Redigiraj',
  crop: 'Obreži',
  crop_and_scan: 'Obreži in skeniraj',
  flip_horizontal: 'Zrcali vodoravno',
  flip_vertical: 'Zrcali navpično',
  there_is_no_text_to_redact_on_this_page: 'Ta stran vsebuje samo slike. Orodje za redigiranje deluje le na straneh z besedilom.',
  color: 'Barva',
  reset: 'Ponastavi',
  upload_to_document: 'Naloži v »{document}«',
  right: 'Desno',
  center: 'Sredinsko',
  description: 'Opis',
  display_title: 'Prikaži naslov',
  with_logo: 'Z logotipom',
  unchecked: 'Neoznačeno',
  price: 'Cena',
  type: 'Vrsta',
  list: 'seznam',
  no_variables: 'Še ni spremenljivk',
  no_variables_description: 'Dodajte oznake [[spremenljivka]] v dokument, da ustvarite dinamične spremenljivke vsebine.',
  type_value: 'Vnesi vrednost',
  equal: 'Enako',
  not_equal: 'Ni enako',
  greater_than: 'Večje od',
  less_than: 'Manjše od',
  contains: 'Vsebuje',
  does_not_contain: 'Ne vsebuje',
  not_empty: 'Ni prazno',
  empty: 'Prazno',
  select_field_: 'Izberi polje ...',
  select_value_: 'Izberi vrednost ...',
  remove_condition: 'Odstrani pogoj',
  add_condition: 'Dodaj pogoj',
  are_you_sure_: 'Ste prepričani?',
  sign_yourself: 'Podpiši sam',
  set_signing_date: 'Nastavi datum podpisa',
  signing_date: 'Datum podpisa',
  signing_date_and_time: 'Datum in čas podpisa',
  send: 'Pošlji',
  remove: 'Odstrani',
  edit: 'Uredi',
  settings: 'Nastavitve',
  ...
  any: 'Karkoli',
  drawn: 'Narisano',
  drawn_or_typed: 'Narisano ali vneseno',
  drawn_or_upload: 'Narisano ali naloženo',
  upload: 'Naloži',
  formula: 'Formula',
  typed: 'Vneseno',
  draw_field_on_the_document: 'Nariši polje na dokument',
  click_to_upload: 'Klikni za nalaganje',
  or_drag_and_drop_files: 'ali povleci in spusti datoteke',
  uploading: 'Nalaganje',
  processing_: 'Obdelava ...',
  add_pdf_documents_or_images: 'Dodaj PDF dokumente ali slike',
  add_documents_or_images: 'Dodaj dokumente ali slike',
  add_a_new_document: 'Dodaj nov dokument',
  replace_existing_document: 'Zamenjaj obstoječi dokument',
  clone_and_replace_documents: 'Kloniraj in zamenjaj dokumente',
  required: 'Obvezno',
  default_value: 'Privzeta vrednost',
  format: 'Format',
  read_only: 'Samo za branje',
  page: 'Stran',
  draw_new_area: 'Nariši novo območje',
  copy_to_all_pages: 'Kopiraj na vse strani',
  more: 'Več',
  add_option: 'Dodaj možnost',
  option: 'Možnost',
  options: 'Možnosti',
  condition: 'Pogoj',
  make_dynamic: 'Naredi dinamično',
  first_party: 'Prva stranka',
  second_party: 'Druga stranka',
  third_party: 'Tretja stranka',
  fourth_party: 'Četrta stranka',
  fifth_party: 'Peta stranka',
  sixth_party: 'Šesta stranka',
  seventh_party: 'Sedma stranka',
  eighth_party: 'Osma stranka',
  ninth_party: 'Deveta stranka',
  tenth_party: 'Deseta stranka',
  eleventh_party: 'Enajsta stranka',
  twelfth_party: 'Dvanajsta stranka',
  thirteenth_party: 'Trinajsta stranka',
  fourteenth_party: 'Štirinajsta stranka',
  fifteenth_party: 'Petnajsta stranka',
  sixteenth_party: 'Šestnajsta stranka',
  seventeenth_party: 'Sedemnajsta stranka',
  eighteenth_party: 'Osemnajsta stranka',
  nineteenth_party: 'Devetnajsta stranka',
  twentieth_party: 'Dvajseta stranka',
  draw: 'Nariši',
  add: 'Dodaj',
  or_add_field_without_drawing: 'Ali dodaj polje brez risanja',
  text: 'Besedilo',
  number: 'Številka',
  signature: 'Podpis',
  initials: 'Inicialke',
  ...
  signature_field: 'Polje za podpis',
  initials_field: 'Polje za inicialke',
  date_field: 'Datumsko polje',
  number_field: 'Številsko polje',
  image_field: 'Polje za sliko',
  file_field: 'Polje za datoteko',
  select_field: 'Izbirno polje',
  checkbox_field: 'Potrditveno polje',
  multiple_field: 'Polje za večkratno izbiro',
  radio_field: 'Polje za izbirno skupino',
  cells_field: 'Polje za celice',
  stamp_field: 'Polje za žig',
  payment_field: 'Plačilno polje',
  phone_field: 'Telefonsko polje',
  draw_a_text_field_on_the_page_with_a_mouse: 'Nariši besedilno polje na stran z miško',
  drag_and_drop_any_other_field_type_on_the_page: 'Povleci in spusti katerokoli drugo vrsto polja na stran',
  click_on_the_field_type_above_to_start_drawing_it: 'Klikni na vrsto polja zgoraj, da začneš risati',
  please_draw_fields_to_prepare_the_document: 'Prosimo, narišite polja, da pripravite dokument.',
  only_pdf_and_images_are_supported: 'Podprti so samo PDF in slike.',
  unlock_sms_verified_phone_number_field_with_paid_plan_use_text_field_for_phone_numbers_without_verification: 'Odklenite polje za telefonsko številko s SMS preverjanjem s plačanim načrtom. Za telefonske številke brez preverjanja uporabite besedilno polje.',
  available_only_in_pro: 'Na voljo samo v Pro',
  failed_to_download_files: 'Prenos datotek ni uspel',
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed: 'Prosimo, dodajte polja za {submitter_name}. Ali pa odstranite {submitter_name}, če jih ne potrebujete.',
  draw_field: 'Nariši polje {field}',
  replace: 'Zamenjaj',
  uploading_: 'Nalaganje ...',
  ...
  letters_only: 'Samo črke',
  regexp_validation: 'Preverjanje z regularnim izrazom',
  custom_validation: 'Preverjanje po meri',
  length_validation: 'Preverjanje dolžine',
  number_range: 'Območje številk',
  enter_pdf_password: 'Vnesi geslo za PDF',
  wrong_password: 'Napačno geslo',
  currency: 'Valuta',
  save_and_preview: 'Shrani in predoglej',
  preferences: 'Nastavitve',
  available_in_pro: 'Na voljo v Pro',
  some_fields_are_missing_in_the_formula: 'V formuli manjkajo nekatera polja.',
  learn_more: 'Več informacij',
  and: 'in',
  or: 'ali',
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document: 'Začni hiter ogled, kako ustvariti in poslati prvi dokument',
  start_tour: 'Začni ogled',
  or_add_from: 'Ali dodaj iz',
  sync: 'Sinhroniziraj',
  syncing: 'Sinhroniziranje ...',
  copy: 'Kopiraj',
  paste: 'Prilepi',
  select_fields: 'Izberi polja',
  draw_fields: 'Nariši polja',
  align_left: 'Poravnaj levo',
  align_right: 'Poravnaj desno',
  align_top: 'Poravnaj na vrh',
  align_bottom: 'Poravnaj na dno',
  fields_selected: '{count} izbranih polj',
  field_added: 'Dodano {count} polje',
  fields_added: 'Dodanih {count} polj',
  revisions: 'Revizije',
  no_revisions_yet: 'Še ni revizij',
  viewing_revision_from: 'Ogled revizije z dne {date}',
  connect_google_drive: 'Poveži Google Drive',
  submitting: 'Oddajanje'
}

export { en, es, it, pt, fr, de, nl, sl }
